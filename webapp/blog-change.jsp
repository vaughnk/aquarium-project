...
<body>
   <script type="text/javascript">
      function delblog() {
         ...
         if (ans == true) {
            document.update.action = "blogDelete.do";
         } else {
            return;
         }
      }
         ...
         <div class="container-fluid pt-4 px-4">
            <div
               ...
               <div class="bg-light rounded h-100 p-4">
                  ...
                  <form action="blogUpdate.do" method="post" name="update">
                     ...
                     <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">작성자</span> <input
                           ...
                           placeholder="제목" aria-label="Username"
                           aria-describedby="basic-addon1" value="${board.memberId}" readonly>
                     </div>
                     <div class="input-group mb-3">
                     ...
                     <div class="input-group mb-3">
                        <div class="col-sm-6" style="padding-right: 5px;">
                           <button type="submit" class="btn btn-primary" style="float: right;">글수정</button>
                        </div>
                        </form>
                        <div class="col-sm-6">
                           <button type="submit" class="btn btn-primary" onClick="delblog()">글삭제</button>
                        </div>
                     </div>
